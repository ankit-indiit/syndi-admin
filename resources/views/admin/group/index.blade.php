            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="header-title mb-3">All Groups </h4>
                            </div>
                            <div class="col-md-6 text-right">
                                <a href="{{ route('group.create') }}" class="btn btn-primary  mb-3">Add Group</a>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <div id="basic-datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="groupDatatable" class="table table-border listing-data-table">
                                            <thead>
                                                <th>Group Name</th>
                                                <th>Contact</th>
                                                <th>Description</th>
