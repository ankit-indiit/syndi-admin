...
!(function (i) {
    ...
    (a.prototype.respChart = function (e, r, t, o) {
        ...
        (a.prototype.initCharts = function () {
            var a = [],
                e = ["#1abc9c", "#f1556c", "#4a81d4", "#e3eaef"];
            if (0 < i("#revenue-chart").length) {
                var r = {
                    labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
                    datasets: [
                        { label: "Current Week", backgroundColor: hexToRGB((o = (t = i("#revenue-chart").data("colors")) ? t.split(",") : e.concat())[0], 0.3), borderColor: o[0], data: [32, 42, 42, 62, 52, 75, 62] },
                        { label: "Previous Week", fill: !0, backgroundColor: "transparent", borderColor: o[1], borderDash: [5, 5], data: [42, 58, 66, 93, 82, 105, 92] },
                    ],
                };
                a.push(
                    this.respChart(i("#revenue-chart"), "Line", r, {
            ...
            if (0 < i("#projections-actuals-chart").length) {
                ...
                a.push(
                    this.respChart(i("#projections-actuals-chart"), "Bar", s, {
                        maintainAspectRatio: !1,
                        legend: { display: !1 },
                        scales: { yAxes: [{ gridLines: { display: !1 }, stacked: !1, ticks: { stepSize: 20 } }], xAxes: [{ stacked: !1, gridLines: { color: "rgba(0,0,0,0.01)" } }] },
                    })
                );
            }
            return a;
